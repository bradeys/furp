...
internal sealed class IdentityRedirectManager(
    ...
    IdentityRedirectUrlValidator redirectUrlValidator)
{
    ...
    public void RedirectTo(string? uri)
    {
        ...
        if (redirectUrlValidator.IsAllowedExternalUri(uri))
        {
        ...
        {
            navigationManager.NavigateTo(navigationManager.ToBaseRelativePath(uri));
            return;
        }
